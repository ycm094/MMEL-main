...
class InputExample(object):
    ...
    def __init__(self, guk, sent, idx, answer=None, mentions=None, prompt=None):
...
class InputFeatures:
    ...
    def __init__(self, guk, input_ids, input_mask, segment_ids, answer_id, img_id, mentions):
        """Constructs a InputExample.
        Args:
    ...
    for k, v in js.items():
        examples.append(
            InputExample(
                ...
                idx=v["id"],
                answer=v["answer"],
                mentions=v["mentions"], # v["entities"], # 
                prompt=v["mentions"] 
            )
        )
...
def convert_examples_to_features(
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        tokens = []
        # label_id = None
        sent = 'Mention: ' + example.prompt + '; Context: ' + example.sent + '.'
        ...
        if example.answer:
            if example.answer not in list(answer_map):
                print(111111)
