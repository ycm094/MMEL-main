...
def read_examples_from_file(args):
    ...
    json.dump(keys_ordered, open(os.path.join(args.dir_output, "img_list.json"), 'w'), indent=2)
...
def convert_examples_to_features(
    ...
    with torch.no_grad():
        for (ex_index, example) in enumerate(examples):
            ...
            # if ex_index == 10:
            #     break
            img_path = args.dataset_path + example.words['imgPath']
...
def main():
    ...
    parser.add_argument(
        "--dataset_path",
        default='/data0/ycm/CODE/MMEL/datasets/WikiMEL/',  #'dm/qid2abs.json',
        type=str,
        # required=True,
        help="The input data.",
    )
    parser.add_argument(
        "--path_qid2abs",
        default=root_path+'dm/nel_121.json',  #'dm/qid2abs.json',
        type=str,
        # required=True,
        help="The input data.",
    )
    parser.add_argument(
        "--path_img",
        default='/home/yangchengmei/CODE/MEL-GHMFC-main/datasets/' + 'WikiMEL/',  #'dm/qid2abs.json',
        type=str,
        # required=True,
        help="The input data.",
    )
    ...
    h5_file = h5py.File(os.path.join(args.dir_output, "resnet_img_feats.h5"), 'w')
